...
// warm saffron/amber raised dots on beige — every raised dot is the same color, mirroring the
// physical device (the on-screen cell is a model of it; the dots carry no per-dot color meaning).
const RAISED =
